...
- `[长工]#realtime-truth-ui@v0.1`: partial-accepted after selector plus App/Home/Cockpit truth wiring, 1280/1440/1920 browser fallback replay and renderer SSR fresh/late/stale/session-lost fixture; configured/online/simulated/source/session semantics are separated, while Electron event p95 and real E2E remain pending.
- `[长工]#realtime-requirements-control@v0.1`: active docs/control owner; records the approximately 60% bounded baseline, A/B fences, quantitative acceptance and remaining Electron p95/trusted-authorizer/real-E2E gaps. P0-C Codex controlled dry-run remains standby pending full A/B acceptance and a second explicit execution authorization.
...
next action:
- PM has independently verified P0-A/P0-B callbacks, file fences, M5 hunk preservation, fixtures, truth UI and 1280/1440/1920 browser fallback; keep P0-C blocked until Electron p95/full A/B checks pass and a fresh explicit Codex dry-run authorization exists.

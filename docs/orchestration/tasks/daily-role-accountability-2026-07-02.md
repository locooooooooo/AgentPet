...
| `[PM]#next-five-day-development@2026-07-18` | active | `docs/orchestration/sessions/next-five-day-development-2026-07-18.md` | Enforce the compressed 2026-07-17 DDL and strict serial order; publish the closeout baseline before the single scheduler worker starts. |
...
| `[PM]#weekly-requirements@2026-07-21` | active | `docs/orchestration/sessions/weekly-requirements-2026-07-21.md` | Own the next-stage same-day requirements truth and keep all external execution gates closed. |
| `[长工]#realtime-p1-scheduler-core@v0.1` | active | `docs/orchestration/tasks/realtime-p1-scheduler-core-v0.1.md` | Implement only the exact expanded five-file fence; runtime script is limited to two legacy fixtures, and S-01 through S-16 plus required counters remain due today. |
...
| `[PM]#weekly-requirements@2026-07-21` weekly-requirements lane | active | `docs/orchestration/status.json` | Own the active weekly lane for the compressed same-day scheduler delivery. |

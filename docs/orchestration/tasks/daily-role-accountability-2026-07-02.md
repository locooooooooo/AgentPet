...
| `[长工]#realtime-connector-runtime@v0.1` | active | `docs/orchestration/tasks/realtime-agent-cockpit-p0-a-connector-runtime-v0.1.md` | Preserve A1-A7 accepted controlled-process evidence while B2 is the only authorized extension; machine-gate stays unchanged and external Agent CLI remains forbidden. |
...
| `[长工]#realtime-production-path-e2e@v0.1` | active | `docs/orchestration/tasks/realtime-agent-cockpit-p0-b2-production-path-e2e-v0.1.md` | Run only controlled non-Agent production-path rehearsal and include overlapping CIM visible-DOM latency. |
...
| `[长工]#realtime-requirements-control@v0.1` | active | `docs/orchestration/sessions/realtime-agent-cockpit-next-stage-2026-07-15.md` | Maintain B2 as the only runtime lane after A7 acceptance and keep P0-C authorization-required; do not conflate controlled local process evidence with real Agent E2E. |
| `[PM]#realtime-cockpit-next-stage@2026-07-15` | active | `docs/orchestration/sessions/realtime-agent-cockpit-next-stage-2026-07-15.md` | Accept or honestly block B2, keep Connector machine gates unchanged, and prepare but do not execute P0-C. |

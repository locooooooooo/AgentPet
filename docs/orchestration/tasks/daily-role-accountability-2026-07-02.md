...
| `[PM]#cockpit-ui-redesign-v3.1@v0.1` | active | `docs/orchestration/tasks/cockpit-ui-redesign-v3.1-v0.1.md` | Supervise the 2026-07-12 bounded visual worker; preserve M5 lifecycle, avatar/keyframes, business logic, connectors, and separate commits. |

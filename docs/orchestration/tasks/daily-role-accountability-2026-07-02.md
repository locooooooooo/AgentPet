...
| `[PM]#cockpit-ui-redesign-v3.2@v0.1` | standby | `docs/orchestration/tasks/cockpit-ui-redesign-v3.2-v0.1.md` | Requirements are ready; wait for explicit P0 implementation dispatch and preserve the doc-only boundary meanwhile. |

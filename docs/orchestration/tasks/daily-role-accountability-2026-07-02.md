...
| `[长工]#hub-runtime-foundation-integration@v0.1` | active | `docs/orchestration/tasks/hub-runtime-foundation-integration-v0.1.md` | Compose the three foundations inside the two-file integration fence and report implemented/tested results without acceptance. |

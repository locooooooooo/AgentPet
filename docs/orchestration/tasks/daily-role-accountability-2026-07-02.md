...
| `[PM]#next-five-day-development@2026-07-18` | standby | `docs/orchestration/sessions/next-five-day-development-2026-07-18.md` | Preserve the two collected pre-gate callbacks; wait for 7-18 Day 1 and keep Day 5 behind its phase gate. |

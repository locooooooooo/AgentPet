...
| `[长工]#realtime-connector-runtime@v0.1` | active | `docs/orchestration/tasks/realtime-agent-cockpit-p0-a-connector-runtime-v0.1.md` | Preserve A1-A7.1/B2 accepted controlled-process evidence; no runtime worker or external Agent CLI execution is authorized. |
...
| `[长工]#realtime-requirements-control@v0.1` | active | `docs/orchestration/sessions/realtime-agent-cockpit-next-stage-2026-07-15.md` | Maintain A7.1/B2 accepted and P0-C authorization-required; do not conflate controlled local process evidence with real Agent E2E. |
| `[PM]#realtime-cockpit-next-stage@2026-07-15` | active | `docs/orchestration/sessions/realtime-agent-cockpit-next-stage-2026-07-15.md` | Preserve accepted A7.1/B2 evidence, keep Connector machine gates unchanged, and hold P0-C behind fresh explicit authorization. |

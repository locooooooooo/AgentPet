...
| `[PM]#next-five-day-development@2026-07-18` | standby | `docs/orchestration/sessions/next-five-day-development-2026-07-18.md` | Preserve the early Day 1/Day 4 requirement artifacts; keep final closeout and Day 5 implementation behind their unchanged gates. |
| `[PM]#weekly-closeout@2026-07-20` | standby | `docs/orchestration/sessions/weekly-closeout-2026-07-20.md` | Keep every pre/final checklist item unchecked until fresh evidence and the real final gate exist. |
| `[短工]#realtime-p1-scheduler-intake@v0.1` | standby | `docs/orchestration/tasks/realtime-p1-scheduler-intake-v0.1.md` | Preserve the accepted requirements and exact file fence; do not dispatch scheduler-core before P0-C acceptance or a new explicit phase waiver. |

...
| `[长工]#realtime-connector-runtime@v0.1` | active | `docs/orchestration/tasks/realtime-agent-cockpit-p0-a-connector-runtime-v0.1.md` | Preserve A1-A6 partial acceptance while A7 is the only authorized runtime extension; machine-gate stays unchanged and external Agent CLI remains forbidden. |
...
| `[长工]#realtime-process-reattach@v0.1` | active | `docs/orchestration/tasks/realtime-agent-cockpit-p0-a7-process-reattach-v0.1.md` | Implement only process fingerprint/restart reattach with a non-Agent controlled child; reject unproven identity to session-lost. |
...
| `[长工]#realtime-requirements-control@v0.1` | active | `docs/orchestration/sessions/realtime-agent-cockpit-next-stage-2026-07-14.md` | Maintain the A7 -> B2 remaining serial gate after A6 acceptance and keep P0-C authorization-required; do not conflate controlled local process evidence with real Agent E2E. |
| `[PM]#realtime-cockpit-next-stage@2026-07-14` | active | `docs/orchestration/sessions/realtime-agent-cockpit-next-stage-2026-07-14.md` | Accept and close each serial runtime lane independently; keep Connector machine gates unchanged and P0-C authorization-required. |

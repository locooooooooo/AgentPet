...
| `[PM]#cockpit-ui-redesign-v3.2@v0.1` | standby | `docs/orchestration/sessions/cockpit-ui-redesign-v3.2-acceptance-2026-07-13.md` | P0 accepted/pushed after independent 1280 replay and two bounded menu corrections; do not dispatch P1/P2 without a fresh decision. |
| `[长工]#realtime-connector-runtime@v0.1` | active | `docs/orchestration/tasks/realtime-agent-cockpit-p0-a-connector-runtime-v0.1.md` | A1-A5 blocked-safe foundation is PM-verified as a partial slice; production authorizer/real reattach/external Agent CLI remain blocked and machine-gate stays unchanged. |
| `[长工]#realtime-truth-ui@v0.1` | active | `docs/orchestration/tasks/realtime-agent-cockpit-p0-b-data-truth-v0.1.md` | Selector, renderer truth wiring, 1280/1440/1920 browser fallback replay, SSR fresh/late/stale/session-lost checks and Electron event p95 are PM-verified as a partial slice; real E2E remains incomplete and no runtime types may be duplicated. |
| `[长工]#realtime-requirements-control@v0.1` | active | `docs/orchestration/sessions/realtime-agent-cockpit-progress-2026-07-13.md` | Maintain the approximately 60% bounded baseline, A/B callback and gate matrix, and keep P0-C Codex dry-run standby pending full A/B acceptance plus a second explicit execution authorization. |
...
| `[PM]#weekly-requirements@2026-07-14` weekly-requirements lane | active | `docs/orchestration/status.json` | Own the active weekly lane; preserve the Day 1 manual-evidence waiver and allow only the same ranch-window owner to continue Day 2 after bounded commit/push. |
| `[PM]#weekly-requirements@2026-07-14` | active | `docs/orchestration/sessions/weekly-requirements-2026-07-14.md` | Maintain W28 planning; Day 1 residual risk stays explicit while Day 2 proceeds under the administrator waiver. |
...
| `[PM]#m5-longworker-dispatch@v0.1` | active | `docs/orchestration/tasks/m5-longworker-dispatch-v0.1.md` | Day 1 manual tray acceptance is waived with residual risk; after bounded commit/push, resume only the same ranch-window owner for Day 2. |
| `[PM]#m5-five-day-development@2026-07-14` | active | `docs/orchestration/sessions/m5-five-day-development-2026-07-14.md` | Track `day2_authorized_by_day1_manual_waiver`; preserve the missing tray evidence as accepted residual risk, commit/push Day 1, and dispatch only the same ranch-window owner for Day 2. |

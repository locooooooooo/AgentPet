...
| `[PM]#weekly-development-plan@2026-07-20` | active | `docs/orchestration/sessions/weekly-development-plan-2026-07-20.md` | Own the combined parallel long-worker batch, bounded integration and final handoff for user-owned unified acceptance. |
| `[长工]#hub-adapter-capability@v0.1` | standby | `docs/orchestration/tasks/hub-adapter-capability-implementation-v0.1.md` | Preserve implemented/tested Adapter admission output and wait for the combined user acceptance. |
...
| `[长工]#hub-lifecycle-execution-closure@v0.1` | standby | `docs/orchestration/tasks/hub-lifecycle-execution-closure-v0.1.md` | Preserve implemented/tested pure executor and rollback matrix; wait for user acceptance and real machine authorization. |
| `[长工]#hub-next-stage-decision-prep@v0.1` | standby | `docs/orchestration/tasks/hub-next-stage-decision-prep-v0.1.md` | Preserve the ready decision matrix; final execute/defer choices remain user-owned. |
| `[长工]#hub-session-dockview-d0@v0.1` | standby | `docs/orchestration/tasks/hub-session-dockview-d0-v0.1.md` | Preserve implemented/tested D0 registry/layout; defer D1-D4 and wait for combined user acceptance. |
...
| `[PM]#weekly-development-plan@2026-07-20` weekly-requirements lane | active | `docs/orchestration/status.json` | Keep the completed combined batch truthful, park all implementation workers and hand one integrated diff to the user for acceptance. |

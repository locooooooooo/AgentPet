...
| `[长工]#realtime-p1-scheduler-core@v0.1` | active | `docs/orchestration/tasks/realtime-p1-scheduler-core-v0.1.md` | Implement only the exact four-file fence; return S-01 through S-16 and required concurrency/spawn/terminal counters today. |

...
| `[长工]#realtime-connector-runtime@v0.1` | active | `docs/orchestration/tasks/realtime-agent-cockpit-p0-a-connector-runtime-v0.1.md` | Preserve A1-A7 accepted controlled-process evidence while B2 is latency-blocked; no runtime worker or external Agent CLI execution is authorized. |
...
| `[长工]#realtime-process-reattach@v0.1` | summarized | `docs/orchestration/sessions/realtime-agent-cockpit-p0-a7-acceptance-2026-07-15.md` | Preserve accepted A7 commit `e2031cd`, zero-child cleanup and explicit synchronous-CIM residual risk. |
| `[长工]#realtime-production-path-e2e@v0.1` | blocked | `docs/orchestration/sessions/realtime-agent-cockpit-p0-b2-production-path-evidence-2026-07-15.md` | Preserve passed lifecycle/terminal DOM evidence and the PM p95 `1524ms` synchronous-CIM blocker; do not rerun before A7.1 acceptance. |
| `[长工]#realtime-async-process-proof@v0.1` | standby | `docs/orchestration/tasks/realtime-agent-cockpit-p0-a7-1-async-process-proof-v0.1.md` | Keep the decision-ready A7.1 packet at authorization_required; no runtime/main implementation is dispatched. |
...
| `[长工]#realtime-requirements-control@v0.1` | active | `docs/orchestration/sessions/realtime-agent-cockpit-next-stage-2026-07-15.md` | Maintain B2 latency-blocked, A7.1 authorization-required and P0-C not eligible; do not conflate controlled local process evidence with real Agent E2E. |
| `[PM]#realtime-cockpit-next-stage@2026-07-15` | active | `docs/orchestration/sessions/realtime-agent-cockpit-next-stage-2026-07-15.md` | Preserve the honest B2 blocker, keep Connector machine gates unchanged, and hold A7.1/P0-C behind fresh authorization. |

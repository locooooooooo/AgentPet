...
| `[短工]#realtime-p1-scheduler-configurable-concurrency@v0.1` | active | `docs/orchestration/tasks/realtime-p1-scheduler-configurable-concurrency-v0.1.md` | Resume serially from the first worker's allowed runtime diff, complete C-01 through C-12 and 2026-07-18 evidence; do not touch `src/types.ts` or execute an external Agent. |

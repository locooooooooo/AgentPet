...
| `[长工]#realtime-connector-runtime@v0.1` | active | `docs/orchestration/tasks/realtime-agent-cockpit-p0-a-connector-runtime-v0.1.md` | Preserve A1-A5 partial acceptance while A6 is the only authorized runtime extension; machine-gate stays unchanged and external Agent spawn remains 0. |
| `[长工]#realtime-trusted-authorizer@v0.1` | active | `docs/orchestration/tasks/realtime-agent-cockpit-p0-a6-trusted-authorizer-v0.1.md` | Implement only the main-owned, intent-bound, single-use A6 authorization boundary; keep A7/B2/P0-C standby. |
...
| `[长工]#realtime-requirements-control@v0.1` | active | `docs/orchestration/sessions/realtime-agent-cockpit-next-stage-2026-07-14.md` | Maintain the A6 -> A7 -> B2 serial gate and keep P0-C authorization-required; do not conflate controlled local process evidence with real Agent E2E. |

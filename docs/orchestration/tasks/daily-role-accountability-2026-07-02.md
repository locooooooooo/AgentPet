...
| `[长工]#realtime-truth-ui@v0.1` | active | `docs/orchestration/tasks/realtime-agent-cockpit-p0-b-data-truth-v0.1.md` | Selector, renderer truth wiring, 1280/1440/1920 browser fallback replay and SSR fresh/late/stale/session-lost checks are PM-verified as a partial slice; Electron p95/real E2E remain incomplete and no runtime types may be duplicated. |

...
| `[长工]#hub-adapter-capability@v0.1` | active | `docs/orchestration/tasks/hub-adapter-capability-implementation-v0.1.md` | Implement and self-test only the two-file Adapter admission fence; report unaccepted results to the manager. |
| `[长工]#hub-install-run-core@v0.1` | active | `docs/orchestration/tasks/hub-install-run-core-v0.1.md` | Implement and self-test only the two-file InstallRun core fence; perform no machine effects and report unaccepted results. |
| `[长工]#hub-dependency-workflow-core@v0.1` | active | `docs/orchestration/tasks/hub-dependency-workflow-core-v0.1.md` | Implement and self-test only the two-file workflow core fence; execute no external Agent and report unaccepted results. |
...
| `[PM]#weekly-development-plan@2026-07-20` weekly-requirements lane | active | `docs/orchestration/status.json` | Own the combined parallel long-worker batch, prevent file overlap, keep external execution at zero and reserve acceptance for the user. |

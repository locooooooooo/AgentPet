...
| `[短工]#realtime-p1-scheduler-configurable-concurrency@v0.1` | active | `docs/orchestration/tasks/realtime-p1-scheduler-configurable-concurrency-v0.1.md` | Own docs-only C-01 through C-12 intake review; keep product worker count zero and do not touch dirty `src/types.ts`. |

...
| `[短工]#realtime-p1-scheduler-configurable-concurrency@v0.1` | active | `docs/orchestration/tasks/realtime-p1-scheduler-configurable-concurrency-v0.1.md` | After the accepted baseline is pushed, implement C-01 through C-12 in the three-file fence; do not touch dirty `src/types.ts` or execute an external Agent. |
